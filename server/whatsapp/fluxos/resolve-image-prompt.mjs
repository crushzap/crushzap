...
export function resolveImagePrompt(text, photoTagContent, personaTraits, options = {}) {
  ...
  const fixedPrompts = [
    ...
    },
    {
      ...
      prompt:
        'close-up, rear view, nude adult woman, anus visible, butt cheeks visible, two hands only resting on butt cheeks, gentle relaxed hands, hands visible but cropped at wrists, no arms visible, natural finger placement, no spreading, no pulling, headless, no face, no upper body, cropped at waist, detailed skin, realistic texture',
      negative:
